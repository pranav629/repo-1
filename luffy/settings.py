...
SECRET_KEY = 'django-insecure-vd%xey@n&f+5@%vw_8=mjuvtqr5jx%wtt&)dyv9y$yuxv^jq%7'

EMAIL_BACKEND = 'django.core.mail.backends.smtp.EmailBackend'

# Your SMTP server (Gmail example)
...
# Your Gmail (or your SMTP server) credentials
EMAIL_HOST_USER = 'startupconnect8@gmail.com'
EMAIL_HOST_PASSWORD = 'dbtp ksln ldhk gwje'
